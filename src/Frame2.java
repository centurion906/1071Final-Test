...
public class Frame2 extends JFrame {
    ...
    public int P1x = 100, P1y = 500, P2x = 700, P2y = 500, flagP1, flagP2;
    private int attcheck, m, a = 0, c, count = 1;

    private P1 player1 = new P1(100, 200);
    private P2 player2 = new P2(700, 200);

    private boolean attP1 = false;
    private boolean attP2 = false;
    ...
    class ImagePanel extends JPanel {
        ...
        public ImagePanel() {
            try {
                ...
                JOptionPane.showMessageDialog(this, "IOException" + e.toString());
            }
        }
...
//                ---------------讓Timer停下------------------------------------
    ...
    class P2 extends JLabel implements Runnable {
        ...
        public P2(int P2x, int P2y) {
            ...
            P2.this.setSize(100, 200);

            P2.this.setIcon(iconP11right);                                                   //P1 right normal
            Image imgp11 = iconP11right.getImage();
            Image imgp13 = imgp11.getScaledInstance(100, 200, 50);
            iconP11right.setImage(imgp13);

            P2.this.setIcon(iconP11left);                                                   //P1 left normal
            Image imgp15 = iconP11left.getImage();
            Image imgp17 = imgp15.getScaledInstance(100, 200, 50);
            iconP11left.setImage(imgp17);
    ...
    public void check() {
        ...
        if (P1HP == 0 || P2HP == 0) {
            ...
            if (((P1x >= P2x - 30 || P1x <= P2x + 30) && (P1y >= P2y - 30 || P1y <= P2y + 30)) && attP1 == true) {
                P2HP = P2HP - 5;
                String P2hp = Integer.toString(P2HP);
                jlbP2NumberHP.setText(P2hp);
            } else if (((P2x >= P1x - 30 || P2x <= P1x + 30) && (P2y >= P1y - 30 || P2y <= P1y + 30)) && attP2 == true) {
                P1HP = P1HP - 5;
